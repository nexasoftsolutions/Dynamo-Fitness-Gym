import { Menu, Play, MessageCircle, Zap, Target, Dumbbell, ArrowRight } from 'lucide-react';
          ...
          <div className="hidden md:flex gap-8 items-center">
            {['Home', 'About', 'Facilities', 'Classes', 'Trainers', 'Pricing'].map((item) => (
              <a 
                key={item} 
                href="#" 
                className={`font-['Space_Mono'] text-[12px] font-bold uppercase tracking-widest transition-all duration-300 hover:text-white ${item === 'About' ? 'text-[#c3f400] border-b-2 border-[#c3f400] pb-1' : 'text-[#c4c9ac]'}`}
              >
                {item}
              </a>
            ))}
